...
public class DefaultAudioItem: AudioItem {
    ...
    public init(audioUrl: String, id: String? = nil, episodeId: String? = nil, artist: String? = nil, title: String? = nil, albumTitle: String? = nil, sourceType: SourceType, artwork: UIImage? = nil) {
    ...
    public func getEpisodeId() -> String? {
        return episodeId
    }
...
public class DefaultAudioItemTimePitching: DefaultAudioItem, TimePitching {
    ...
    public override init(audioUrl: String, id: String?, episodeId: String?, artist: String?, title: String?, albumTitle: String?, sourceType: SourceType, artwork: UIImage?) {
        self.pitchAlgorithmType = AVAudioTimePitchAlgorithm.lowQualityZeroLatency
        super.init(audioUrl: audioUrl, id: id, episodeId: episodeId, artist: artist, title: title, albumTitle: albumTitle, sourceType: sourceType, artwork: artwork)
    }
